...
public class Huffman {
	...
	public static StringBuilder buildHuffmanTree(String text) throws IOException
	{ 
		...
		System.out.println("Each Character And Their Frequencies:" + freq);
		...
		for (Map.Entry<Character, String> entry : huffmanCode.entrySet()) 
		{
			...
			charFrequency = freq.get(entry.getKey());
			frequencyBinary = String.format("%08d",Integer.parseInt(Integer.toBinaryString(charFrequency)));
			
	 		/*Create the file header consisting of the binary representation
			of each character and their frequencies*/
		...
		WriteFile.writeStrings("Compressed", encoded.toString());
		return encoded;
	} 
